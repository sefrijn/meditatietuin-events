<section class="relative">
	...
	<div class="bg-black bg-opacity-30 max-width-prose mx-auto py-24 relative z-10 text-center text-white">
		<h1 class="text-shadow text-6xl text-white font-semibold"><?php the_title(); ?></h1>
		<p class="text-shadow mt-4 -mb-1 label">door</p>
		<h2 class="text-shadow text-3xl text-orange-medium teacher font-semibold normal-case">
			<?php 
		...
		<div class="text-shadow text-2xl font-semibold text-orange-medium date">
